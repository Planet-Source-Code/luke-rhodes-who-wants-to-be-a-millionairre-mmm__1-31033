...
c = 1
an = "b"
Form1.Label20.Caption = "This Is the unfinished set. Restart the program until it?" 'put any question here
Form1.Label21.Caption = "doesnt"
Form1.Label22.Caption = "say" ' answer must be put here.
Form1.Label23.Caption = "this"
